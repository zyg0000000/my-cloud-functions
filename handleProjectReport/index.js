 ...
 * @version 3.8 - Archived Project Support
 * @description [V3.8] 增加归档项目支持，返回最后有数据的日期
...
async function getReportData(db, projectId, date) {
    ...
    return { overview, details, missingDataVideos, lastReportDate };
}
